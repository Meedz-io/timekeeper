module.exports = async (page, account_id) => {
    ...
    try {
        ...
        const profile_infos = await page.evaluate(() => {
...
const getExtraDetails = async (page) => {
    ...
    return await page.evaluate(() => ({
        email: document.querySelector(".artdeco-modal__content .ci-email")
            && document.querySelector(".artdeco-modal__content .ci-email a").innerText,
        phone_number: document.querySelector(".artdeco-modal__content .ci-phone")
            && document.querySelector(".artdeco-modal__content .ci-phone li span:nth-child(1)").innerText,
    }))
}